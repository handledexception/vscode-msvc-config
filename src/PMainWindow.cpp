...
PMainWindow::PMainWindow(wchar_t* title, uint32_t cx, uint32_t cy, uint32_t width, uint32_t height, HINSTANCE hinst, HWND parent)
:
PWindow::PWindow(title, cx, cy, width, height, hinst, parent)
{
}
